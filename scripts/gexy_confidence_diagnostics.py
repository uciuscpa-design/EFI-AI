...
from packages.gexy.confidence_diagnostics import build_confidence_diagnostics
from packages.gexy.log_text import read_log_text


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Audit GEXY live-prediction confidence saturation without changing the predictor"
    )
    ...
    with TemporaryDirectory(prefix="gexy-confidence-diagnostics-") as temp_dir:
